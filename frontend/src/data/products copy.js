...
const products = [
  {
    ...
    description: "Premium cold-pressed Kacchi Ghani Mustard Oil - rich in omega-3 and omega-6 fatty acids.",
    description_hi: "प्रीमियम कोल्ड-प्रेस्ड सरसों का तेल - ओमेगा-3 और ओमेगा-6 फैटी एसिड से भरपूर।",
    usage: "Cooking, frying,  making long-lasting pickles (Achaar), and external massage for skin and hair",
    usage_hi: "खाना पकाने, तलने, अचार बनाने और  त्वचा एवं बालों की मालिश के लिए उपयोगी",
    ...
    healthBenefits: ["Rich in MUFA for heart health",
      ...
      "Traditional remedy for respiratory relief when used topically",
       "Supports heart health", "Good for skin and hair when used topically"],

    healthBenefits_hi: ["हृदय स्वास्थ्य के लिए MUFA से भरपूर",
      "भोजन संरक्षण के लिए प्राकृतिक एंटी-बैक्टीरियल गुण",
      "पाचन और रक्त संचार को उत्तेजित करता है",
      "श्वसन राहत के लिए पारंपरिक उपचार", "हृदय स्वास्थ्य में सहायक", 
  ...
  },
  {
    ...
    description: "Pure cold-pressed groundnut oil sourced from local farmers. It has a high smoke point and a delicate nutty flavor that doesn't overpower the food.",
    description_hi: "शुद्ध कोल्ड-प्रेस्ड मूंगफली का तेल - इसका स्मोक पॉइंट उच्च है और स्वाद हल्का नटी है जो खाने के असली स्वाद को दबने नहीं देता।",
    usage: "Best for deep frying snacks like Pakoras and Puris, and making Indian chutneys.",
    usage_hi: "पकोड़े और पूरियों को तलने और भारतीय चटनी बनाने के लिए सर्वश्रेष्ठ।",
    storage: "Store in a cool place away from sunlight",
    storage_hi: "धूप से दूर ठंडी जगह पर स्टोर करें।",
    manufacturer: "Madhuban Oils Co.",
    ...
    healthBenefits: [
        ...
        "High smoke point for frying", "Good source of vitamin E", "May support cardiovascular health"],
    healthBenefits_hi: ["कोलेस्ट्रॉल कम करने वाले फाइटोस्टेरॉल युक्त",
      "विटामिन ई (एंटीऑक्सीडेंट) का समृद्ध स्रोत",
      "उच्च तापमान पर सुरक्षित (ऑक्सीकरण प्रतिरोधी)",
      "त्वचा के स्वास्थ्य और एंटी-एजिंग में सहायक","तलने के लिए उच्च स्मोक पॉइंट", "विटामिन ई का अच्छा स्रोत", "हृदय स्वास्थ्य को बेहतर बना सकता है"],
    certifications: ["FSSAI"]
  },
  {
    id: 3,
